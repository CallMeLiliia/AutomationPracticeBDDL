...
@Override
public <X> void beforeGetScreenshotAs(OutputType<X>
...
@Override
public void beforeGetText(WebElement element, WebDriver
...
@Override
public void afterGetText(WebElement element, WebDriver
